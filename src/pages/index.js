      ...
      <div className="max-w-2xl mx-auto lg:px-6 px-2 py-6">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="flex justify-center my-8">
            <button
              type="submit"
              className="sm:w-full lg:w-40 bg-indigo-600 text-white rounded-lg p-2 hover:bg-indigo-500"
            >
              Get Result
            </button>
          </div>
        ...
        <div>
          ...
          <br />
          <pre className="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-500 select-none">
